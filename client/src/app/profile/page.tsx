    ...
    <ProtectedRoute>
      <div className="gradient-bg grid-pattern min-h-screen">
        ...
        <main className="mx-auto max-w-4xl px-4 pb-16 pt-24 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 glass-card flex items-center gap-4 rounded-2xl p-6">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-cyan-500 text-2xl font-bold text-white">
